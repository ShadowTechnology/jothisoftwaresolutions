...
export const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-dark pt-20" aria-label="Jothi Software Solutions — Hero Section">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-sm text-muted-foreground">Trusted by 200+ Businesses Across Tamil Nadu</span>
          </motion.div>

          {/* Headline — H1 is the most important SEO element on the page */}
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-bold leading-tight mb-6">
            ...
            <span className="text-2xl md:text-3xl lg:text-4xl font-semibold text-muted-foreground">
              Best Digital Marketing Agency in Ambur, Tamil Nadu
            </span>
          </h1>

          {/* Subheadline with semantic brand variants */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
            We craft data-driven digital marketing strategies that amplify your brand, 
            drive engagement, and deliver measurable growth. <strong>Jothi Software Solution</strong> is 
            trusted by 200+ businesses across Tamil Nadu for SEO, Social Media Marketing, Website Development & more.
          </p>
